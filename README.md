...
<html lang="en">
    ...
    <body>
        <div class="bookpage">
            ...
            <div class="mypic">
                <img src="image.jpeg" width="130" height="145" alt="">
            </div>
            <div class="id">
                <hr style="color: orange;">
            </div>
            <div class="author">
               <p><b>Tom Francies Xaviour</b></p>
            </div>
            <div class="pub">
                SEC
            </div>
...
we have now succesfully created a cover page design using django projects, html and css
